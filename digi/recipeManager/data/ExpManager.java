 ...
 *         Credit to nisovin
 *         (http://forums.bukkit.org/threads/experienceutils-make-giving-taking-exp-a-bit-more-intuitive
 *         .54450/#post-1067480)
...
public class ExpManager
{
	 ...
	 */
	public ExpManager(Player player)
	{
		this.player = player;
	}
	...
	{
		int xp = Math.max(getCurrentExp() + amt, 0); // Digi: added Math.max() to avoid negative values
